...
def make_vobiz_ivr_call(customer_number: str, customer_name: str = "Customer", voice: str = "Polly.Aditi"):
    """
...
if __name__ == "__main__":
    ...
    make_vobiz_ivr_call(target_number, "Surbhi", voice="Polly.Aditi")
