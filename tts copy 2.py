...
async def generate_pcm(text: str, lang_code: str = "hi") -> bytes:
    ...
    # ── Step 5: Audio is already 8kHz mu-law (from format=ULAW & sample_rate=8000) ──
    print(f"✅ Audio ready for Twilio: {len(combined_audio)} bytes (skipping FFmpeg, already ULAW)")
