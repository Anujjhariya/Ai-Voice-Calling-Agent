...
def book_meeting(name: str, dt_str: str, service_name: str = "IT Service") -> str:
    """
    Book a 30-minute meeting on Google Calendar.
    - name: customer's name
    - dt_str: datetime string in format "YYYY-MM-DD HH:MM"
    - service_name: The service they inquired about
    ...
    try:
        ...
        # Check for overlaps
        start_rfc3339 = start_dt.isoformat() + "+05:30"
        end_rfc3339 = end_dt.isoformat() + "+05:30"
        ...
        event = {
            "summary": f"Meeting with {name} for {service_name}",
            "description": f"Customer Name: {name}\nInterested Service: {service_name}\nBooked via Binjwa IT Solutions IVR System.",
            "start": {
            ...
            "attendees": [
                {"email": "rajnandini.binjwaitsolution@gmail.com"}
            ]
        }
